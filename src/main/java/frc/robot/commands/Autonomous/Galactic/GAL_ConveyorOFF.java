...
public class GAL_ConveyorOFF extends CommandBase {
  Stage12ConveyorSubsystem stage12ConveyorSubsystem;
  /**
   * Creates a new GAL_ConveyorOFF.
   */
  public GAL_ConveyorOFF(Stage12ConveyorSubsystem subsystem) {
  ...
  @Override
  public void execute() {
    stage12ConveyorSubsystem.stage1Conveyor(0);
    stage12ConveyorSubsystem.stage2Conveyor(0);
  }
